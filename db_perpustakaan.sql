...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2022 at 10:34 AM
...
('2000123', 'Norman', 'Ilmu Komunikasi'),
('2000385', 'Raihan Taufiq', 'Ilmu Komputer');
...
INSERT INTO `peminjaman` (`id_peminjaman`, `member`, `buku`, `status`) VALUES
(3, '2000123', 1, 'Belum'),
(6, '2000385', 4, 'Sudah');
...
--
ALTER TABLE `peminjaman`
  ADD CONSTRAINT `peminjaman_ibfk_1` FOREIGN KEY (`buku`) REFERENCES `buku` (`id_buku`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `peminjaman_ibfk_2` FOREIGN KEY (`member`) REFERENCES `member` (`nim`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
